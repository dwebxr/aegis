...
/** Layers icon — represents RICH CONTEXT / Contextual depth */
export const ContextIcon: React.FC<IconProps> = ({ s = 14 }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/** Alert triangle — represents HIGH SLOP RISK */
export const SlopRiskIcon: React.FC<IconProps> = ({ s = 14 }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/** Lightbulb — represents INSIGHTFUL */
export const InsightIcon: React.FC<IconProps> = ({ s = 14 }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9 18h6" />
    <path d="M10 22h4" />
...
/** Shield-check — represents CREDIBLE */
export const CredibleIcon: React.FC<IconProps> = ({ s = 14 }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
