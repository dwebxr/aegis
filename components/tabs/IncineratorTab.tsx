...
export const IncineratorTab: React.FC<IncineratorTabProps> = ({ isProc, onAnalyze, isAnalyzing, mobile }) => {
  ...
  return (
    <div style={{ animation: "fadeIn .4s ease" }}>
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 13, color: "#64748b", marginTop: 4 }}>AI-powered content quality evaluation</p>
      </div>
