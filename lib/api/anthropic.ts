 ...
 * routes. Overridable via ANTHROPIC_MODEL so a model retirement (2026-07-19:
 * claude-sonnet-4-20250514 started returning 404) is an env flip, not a
 * deploy. Search call sites before bumping the fallback — confirm none want
